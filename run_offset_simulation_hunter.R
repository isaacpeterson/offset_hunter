...
user_simulation_params = initialise_user_simulation_params(user_global_params$time_steps, user_global_params$features_to_use_in_simulation)

user_feature_params = initialise_user_feature_params(user_global_params$features_to_use_in_simulation)
